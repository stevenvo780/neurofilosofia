# 2b - Hinton - (1992) Traduccion Cuidada al Espanol

**Autor:** Geoffrey E. Hinton  
**Fuente original:** *Scientific American*, septiembre de 1992  
**Base de esta version:** reconstruccion editada a partir del PDF original y del OCR conservado en los materiales del curso  
**Nota:** esta es una traduccion de estudio cuidada en espanol, no una traduccion oficial publicada.

## Como aprenden las redes neuronales a partir de la experiencia

Las redes neuronales artificiales pueden aprender a representar informacion compleja. Al hacerlo, ofrecen una manera de pensar como podria el cerebro humano adquirir representaciones internas sin recibir instruccion explicita.

El cerebro es una computadora extraordinaria. Puede interpretar entradas sensoriales ruidosas a una velocidad asombrosa: puede distinguir un susurro en una sala concurrida, reconocer un rostro con mala iluminacion e inferir significados no explicitos en el lenguaje. Mas impresionante aun, aprende a construir las representaciones internas que hacen posibles esas capacidades.

Como todavia sabemos relativamente poco sobre la manera en que el cerebro se entrena a si mismo, abundan las teorias del aprendizaje. Hinton presenta las redes neuronales artificiales como una forma de poner a prueba esas teorias. La idea no es reproducir el cerebro en todos sus detalles biologicos, sino identificar un conjunto limitado de rasgos relevantes e implementarlos en modelos computacionales. Estos modelos son idealizaciones burdas, pero resultan utiles porque permiten descartar hipotesis poco plausibles y explorar mecanismos que podrian estar en la base del aprendizaje.

## Neuronas biologicas y neuronas artificiales

Una neurona biologica recibe senales a traves de las dendritas, transmite actividad por medio de su axon y afecta a otras neuronas mediante las sinapsis. El aprendizaje ocurre cuando cambia la eficacia sinaptica, modificando asi la influencia que una neurona ejerce sobre otra.
