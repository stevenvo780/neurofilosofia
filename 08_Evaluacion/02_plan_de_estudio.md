...
```mermaid
graph LR
  F[Fundamentos<br/>Bechtel-Mandik<br/>Daugman<br/>Hinton<br/>Bickle] -->|qué es el campo| M[Método<br/>Bechtel epistem.<br/>Raichle]
  M -->|cómo se sabe| C[Conceptos puente<br/>Representación<br/>Predicción<br/>Interocepción]
  C -->|herramientas listas| K[Casos<br/>Visión, Memoria, Lenguaje,<br/>Emoción, Ejecutivas, Conciencia]
  K -->|integración| S[Síntesis<br/>Webb, Nave releído,<br/>Dos posturas]
```
