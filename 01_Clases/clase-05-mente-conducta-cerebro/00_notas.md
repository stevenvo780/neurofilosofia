...
```mermaid
flowchart TB
    Clinica[Clínica neuropsiquiátrica:<br/>Anton, Cotard, anosognosia] --> Tres{Tres posiciones}
    Tres --> Red[Reduccionismo<br/>localizacionista]
    Tres --> Aut[Autonomía fuerte<br/>de lo mental]
    Tres --> Eme[Emergentismo<br/>sistémico]
    Red -->|insuficiente para<br/>Cotard| Limite1[Límite]
    Aut -->|desconecta<br/>biología| Limite2[Límite]
    Eme --> Autop[Autopoiesis<br/>Maturana-Varela]
    Eme --> Enac[Enactivismo<br/>Varela-Thompson]
    Eme --> Multi[Multinivel<br/>Bechtel-Craver]
    Autop --> Org[Organismo<br/>corporizado]
    Enac --> Org
    Multi --> Org
    Org --> Integr[Integración<br/>funcional]
    Integr --> Mente[Mente como<br/>propiedad emergente]
    Mente -.audita.-> BH[Falacia mereológica<br/>Bennett-Hacker]
```
