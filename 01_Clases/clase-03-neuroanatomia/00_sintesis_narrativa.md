...
```mermaid
flowchart TD
    Mundo[Mundo físico] -->|señales fragmentarias| Receptores
    Receptores -->|transducción| SNP
    SNP --> Talamo[Tálamo<br/>relevo + control]
    Talamo --> Cortex[Corteza primaria<br/>S1, V1, A1]
    Cortex --> Asoc[Áreas asociativas<br/>multimodales]
    Asoc --> Ventral[Vía ventral<br/>'qué']
    Asoc --> Dorsal[Vía dorsal<br/>'dónde/cómo']
    Asoc --> GB[Ganglios basales<br/>selección + automatización]
    Ventral --> Repr[Representación integrada]
    Dorsal --> Repr
    GB --> Accion[Acción]
    Repr --> Accion
    Insula[Ínsula<br/>interocepción] --> Repr
    Repr -.feedback.-> Cortex
    Repr -.feedback.-> Talamo
```
